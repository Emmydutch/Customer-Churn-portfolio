...
The final Streamlit application contains an executive overview, customer analysis, churn drivers, geographic analysis, an explainable customer-risk predictor, a retention simulator, and methodology documentation. It supports light and dark themes and was verified with 24 automated tests, responsive browser checks, and a clean deployment environment.
...
5. Adjust campaign assumptions in the Retention Simulator.
6. Close with methodology, limitations, and responsible-use controls.
